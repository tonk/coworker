...
export const ticketsApi = {
  ...
  addMessage:   (cid, id, body, isPrivate = false) => client.post(`/customers/${cid}/tickets/${id}/messages`, { body, is_private: isPrivate }),
  ...
  inboxMessage: (id, body, isPrivate = false) => client.post(`/tickets/inbox/${id}/messages`, { body, is_private: isPrivate }),
