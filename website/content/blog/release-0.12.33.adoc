...
WarmDesk `{warmdesk-version}` makes the weekly time sheet feel more like a spreadsheet: reusable *time macros* for recurring work patterns, richer copy/cut/paste, and quicker row editing.
...
The *User Guide* PDF shipped with `{warmdesk-version}` documents macros, copy/cut/paste, and row editing on the Log Time tab.
