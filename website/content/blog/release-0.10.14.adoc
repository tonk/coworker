...
Download `{warmdesk-version}` from the link:download.adoc[download page] or upgrade your existing installation — database schema is unchanged in this release.
