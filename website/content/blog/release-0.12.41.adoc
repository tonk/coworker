...
WarmDesk `{warmdesk-version}` adds a chart view to the time-tracking report, so you can see the shape of your logged time at a glance instead of scanning table rows.
