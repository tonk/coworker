...
TIP: Promote the first user to admin by running `UPDATE users SET global_role='admin' WHERE id=1;` in the SQLite shell, or via another admin account once the first admin exists.
